...
import com.example.actividad6.viewModels.PreferencesViewModel
...
fun SettingsView(preferencesViewModel: PreferencesViewModel) {
    ...
    val savedAge = preferencesViewModel.age.collectAsState(initial = 0)
    val savedName = preferencesViewModel.name.collectAsState(initial = "")
    val savedHeight = preferencesViewModel.height.collectAsState(initial = 0.0)
    val savedWeight = preferencesViewModel.weight.collectAsState(initial = 0.0)
    val savedHobby = preferencesViewModel.hobby.collectAsState(initial = "")
